...
import {
  ...
  ChevronRight,
  Bot,
  Sparkles, // Added for Opportunities
  GraduationCap // Added for Opportunities
} from "lucide-react"
...
const NAV_ITEMS = [
  ...
  { label: "WhatsApp Support", href: "/whatsapp-support", icon: WhatsAppIcon, description: "Chat with us" },
]
