          ...
          <div className="mt-24 space-y-32">
            ...
            <section className="grid lg:grid-cols-2 gap-16 items-center">
              <div className="space-y-8">
                ...
                <h2 className="text-4xl md:text-5xl font-black text-[#0B1F3A] uppercase tracking-tighter font-poppins italic">Our <span className="text-blue-600">Mission</span></h2>
            ...
            <section className="space-y-16">
              <div className="text-center space-y-4">
                <h2 className="text-4xl md:text-6xl font-black text-[#0B1F3A] uppercase tracking-tighter font-poppins italic">Foundational <span className="text-[#1FA774]">Values</span></h2>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                {[
                  ...
                  <Card key={i} className="rounded-[2.5rem] border-none shadow-xl hover:shadow-2xl transition-all p-10 space-y-6 bg-slate-50 group">
                    ...
                    <h3 className="text-2xl font-black text-[#0B1F3A] uppercase tracking-tighter font-poppins">{val.title}</h3>
            ...
            <section className="bg-[#0B1F3A] rounded-[4rem] p-12 md:p-24 text-white overflow-hidden relative">
              ...
              <div className="relative z-10 grid lg:grid-cols-2 gap-16 items-center">
                <div className="space-y-8">
                  ...
                  <h2 className="text-4xl md:text-6xl font-black uppercase tracking-tighter font-poppins italic">Our <span className="text-[#4ADE80]">Story</span></h2>
