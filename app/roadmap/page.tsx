  ...
  return (
    <DashboardLayout>
      <div className="space-y-12 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 animate-in fade-in duration-700">
        ...
        {/* --- HERO SECTION --- */}
        <section className="relative rounded-3xl overflow-hidden bg-primary min-h-[300px] flex items-center shadow-lg border-b-8 border-emerald-500">
          <div className="absolute inset-0 z-0">
            <Image
              src="/roadmap-journey.png"
              alt="Roadmap Hub"
              fill
          ...
          <div className="relative z-20 w-full p-8 md:p-12 flex flex-col md:flex-row items-center justify-between gap-8">
            <div className="space-y-4 max-w-2xl">
              <div className="inline-flex items-center gap-2 px-3 py-1 bg-white/10 border border-white/20 rounded-full backdrop-blur-md">
                ...
                <span className="text-emerald-400 font-semibold text-xs uppercase tracking-wide">Strategy Hub: Roadmap Engine</span>
              </div>
