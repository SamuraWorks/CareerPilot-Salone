    ...
    <DashboardLayout>
      <div className="space-y-12 max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-8 animate-in fade-in slide-in-from-bottom-4 duration-700">
          ...
          <div className="relative z-20 w-full px-10 md:px-16 flex flex-col md:flex-row items-center justify-between gap-10 pt-10">
            <div className="flex flex-col md:flex-row items-center gap-10 text-center md:text-left">
              ...
              <div className="space-y-4">
                {!isEditing ? (
                  <>
                    <h1 className="text-4xl md:text-7xl font-black text-white tracking-tighter leading-none font-poppins uppercase italic">{profile.name}</h1>
                    <p className="text-xl md:text-2xl text-[#4ADE80] font-black italic tracking-tight font-inter border-l-4 border-[#1FA774] pl-6 uppercase">{profile.university}</p>
                  </>
                ) : (
                  <div className="space-y-4 max-w-sm">
                    <Input
                      ...
                      className="h-16 rounded-2xl text-2xl font-black font-poppins tracking-tighter bg-white/5 text-white border-white/20 focus:border-[#1FA774] shadow-inner uppercase italic"
                      placeholder="Full Name"
                    />
                    <Input
                      value={profile.university}
                      onChange={(e) => setProfile({ ...profile, university: e.target.value })}
                      className="h-12 rounded-xl font-bold font-inter bg-white/5 text-white border-white/20 italic"
                      placeholder="University / Organization"
                    />
                  </div>
                )}
                <div className="flex flex-wrap justify-center md:justify-start gap-3 pt-2">
                  <Badge className="bg-[#1FA774] text-white border-none font-black font-poppins text-[10px] uppercase tracking-[0.2em] px-4 py-2 italic shadow-lg shadow-[#1FA774]/20">Active Operative</Badge>
                  <Badge variant="outline" className="border-white/20 font-black font-poppins text-[10px] uppercase tracking-[0.2em] px-4 py-2 text-white/60 italic">Profile Level 04</Badge>
                </div>
              </div>
            </div>
            ...
            <div className="flex flex-col gap-4 min-w-[200px]">
              <Link
                href="/dashboard"
                className="group inline-flex items-center gap-3 text-white/40 hover:text-white transition-all font-black font-poppins text-[10px] uppercase tracking-[0.3em] mb-4 md:mb-0 italic"
              >
              ...
              {!isEditing ? (
                <Button
                  ...
                  className="rounded-3xl h-16 px-10 font-black font-poppins text-[10px] uppercase tracking-widest gap-3 bg-[#1E5EFF] text-white shadow-2xl shadow-[#1E5EFF]/30 hover:bg-[#1FA774] hover:scale-[1.05] active:scale-95 transition-all border-none italic"
                >
                ...
                <Button
                  ...
                  className="rounded-3xl h-16 px-10 font-black font-poppins text-[10px] uppercase tracking-widest gap-3 bg-red-500/10 text-red-500 border-2 border-red-500/20 shadow-xl hover:bg-red-500 hover:text-white transition-all active:scale-95 italic"
                >
                  <X className="w-4 h-4" />
                  Abort Changes
                </Button>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
          ...
          <Card className="p-10 rounded-[3.5rem] border-none bg-white shadow-sm hover:shadow-2xl transition-all space-y-10 relative overflow-hidden group">
            ...
            <div className="flex items-center gap-4 relative z-10">
              ...
              <h3 className="text-xl font-black font-poppins uppercase tracking-tighter text-[#0B1F3A] italic">Core Identity Nodes</h3>
            </div>

            <div className="space-y-8 relative z-10">
              <div className="space-y-3">
                <Label className="text-[10px] font-black font-poppins text-slate-400 uppercase tracking-[0.3em] px-2 italic">Intelligence Channel (Email)</Label>
                {!isEditing ? (
                  <div className="p-6 rounded-[2rem] bg-slate-50 font-black font-inter text-lg text-[#0B1F3A] border border-transparent italic">
                    {profile.email}
                  </div>
                ) : (
                  <Input
                    ...
                    className="h-16 rounded-[2rem] font-black font-inter text-lg border-2 border-slate-100 bg-white focus:border-[#1E5EFF] transition-all italic"
                  />
                )}
              </div>

              <div className="space-y-3">
                <Label className="text-[10px] font-black font-poppins text-slate-400 uppercase tracking-[0.3em] px-2 italic">Tactical Line (WhatsApp)</Label>
                {!isEditing ? (
                  <div className="p-6 rounded-[2rem] bg-slate-50 font-black font-inter text-lg text-[#0B1F3A] border border-transparent italic">
                    {profile.phone}
                  </div>
                  ...
                  <Input
                    ...
                    className="h-16 rounded-[2rem] font-black font-inter text-lg border-2 border-slate-100 bg-white focus:border-[#1FA774] transition-all italic"
                  />
                )}
              </div>
            </div>
          ...
          <Card className="p-10 rounded-[3.5rem] border-none bg-white shadow-sm hover:shadow-2xl transition-all space-y-10 relative overflow-hidden group">
            ...
            <div className="flex items-center gap-4 relative z-10">
              ...
              <h3 className="text-xl font-black font-poppins uppercase tracking-tighter text-[#0B1F3A] italic">Strategic Objectives</h3>
            </div>

            <div className="space-y-6 relative z-10">
              <div className="space-y-3">
                <Label className="text-[10px] font-black font-poppins text-slate-400 uppercase tracking-[0.3em] px-2 italic">Primary Mission</Label>
                <div className="p-6 rounded-[2rem] bg-slate-50 font-black font-inter text-lg text-[#0B1F3A] border-l-4 border-[#1FA774] italic">
                  {globalProfile.careerGoal || "Undefined"}
                </div>
              </div>

              <div className="space-y-3">
                <Label className="text-[10px] font-black font-poppins text-slate-400 uppercase tracking-[0.3em] px-2 italic">Areas of Operation</Label>
          ...
          <Card className="p-10 rounded-[3.5rem] border-none bg-[#0B1F3A] shadow-2xl space-y-10 relative overflow-hidden group">
            ...
            <div className="flex items-center gap-4 relative z-10">
              ...
              <h3 className="text-xl font-black font-poppins uppercase tracking-tighter text-white italic">Asset Encryption Vault</h3>
            </div>
            ...
            <div className="space-y-6 relative z-10">
              <div className="p-6 rounded-[2.5rem] bg-white/5 border border-white/10 flex items-center justify-between group/file cursor-pointer hover:bg-white/10 transition-all shadow-xl">
                <div className="flex items-center gap-6">
                  ...
                  <div>
                    <div className="text-base font-black font-poppins text-white uppercase tracking-tight italic">Graduate_Dossier_2s026</div>
                    <div className="text-[10px] font-black font-inter text-[#4ADE80] uppercase mt-1 tracking-widest opacity-80 italic">Verified by AI Nexus</div>
                  </div>
                </div>
                <Badge className="bg-[#4ADE80]/10 text-[#4ADE80] border border-[#4ADE80]/20 font-black font-poppins text-[9px] uppercase tracking-widest px-4 py-2 italic">Tactical</Badge>
              </div>

              <Link href="/cv-builder" className="block pt-2">
                <Button className="w-full h-20 rounded-[2.5rem] bg-white text-[#0B1F3A] hover:bg-[#1FA774] hover:text-white font-black font-poppins uppercase text-[10px] tracking-[0.3em] transition-all shadow-2xl active:scale-95 gap-3 border-none">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-16">
              <div className="space-y-8">
                <div className="flex items-center gap-4">
                  ...
                  <h3 className="text-xl font-black font-poppins uppercase tracking-tighter text-[#0B1F3A] italic">Neural Interface</h3>
                </div>
                <div className="flex gap-6">
                  {(['English', 'Krio'] as const).map(l => (
                    <button
                      ...
                      className={`flex-1 h-20 rounded-[2.5rem] font-black font-poppins uppercase tracking-[0.2em] text-[11px] border-4 transition-all italic ${language === l ? 'border-[#1E5EFF] bg-[#1E5EFF] text-white shadow-2xl shadow-[#1E5EFF]/30 scale-105' : 'border-white bg-white text-slate-400 hover:border-slate-200 shadow-sm'
                        }`}
                    >
                      {l} Perspective
                    </button>
              ...
              <div className="space-y-8">
                <div className="flex items-center gap-4">
                  ...
                  <h3 className="text-xl font-black font-poppins uppercase tracking-tighter text-[#0B1F3A] italic">WhatsApp Nexus</h3>
                </div>
                <div className="flex items-center justify-between p-8 rounded-[3rem] bg-white border border-slate-100 shadow-xl group/toggle">
                  <div className="space-y-2">
                    <div className="font-black font-poppins text-[#0B1F3A] uppercase text-xs tracking-[0.2em] italic">Intelligence Sync</div>
                    <div className="text-xs text-slate-400 font-bold font-inter italic max-w-xs">Automated milestone injection into your WhatsApp terminal</div>
                  </div>
                  <button
        ...
        <div className="flex flex-col sm:flex-row justify-between items-center py-12 border-t-4 border-slate-50 gap-10">
          <button
            onClick={() => logout()}
            className="group flex items-center gap-4 text-[10px] font-black font-poppins uppercase tracking-[0.4em] text-red-500 hover:text-red-600 transition-all italic"
          >
