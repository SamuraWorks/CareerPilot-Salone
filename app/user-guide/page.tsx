            ...
            <main className="flex-1 pb-32">
                ...
                <section className="relative min-h-[450px] flex items-center bg-[#0B1F3A] overflow-hidden border-b-8 border-b-[#1FA774]">
                        ...
                        <div className="max-w-4xl space-y-10 text-center mx-auto">
                            ...
                            <div className="space-y-6 text-center">
                                ...
                                <p className="text-xl md:text-2xl text-slate-300 font-medium font-sans max-w-2xl mx-auto leading-relaxed border-transparent italic">
                ...
                <div className="max-w-6xl mx-auto px-6 mt-20">
                                    ...
                                    <div className="flex flex-col lg:flex-row gap-12">
                                        <div className="lg:w-1/3 space-y-6">
                                            ...
                                            <div className="space-y-2">
                                                ...
                                                <h2 className="text-3xl font-black text-[#0B1F3A] uppercase tracking-tighter font-sans italic">{section.title}</h2>
                                        ...
                                        <div className="lg:w-2/3 space-y-10">
                                            {section.items.map((item, j) => (
                                                <div key={j} className="space-y-4 pl-10 border-l-4 border-slate-100 group-hover:border-[#1FA774] transition-all relative">
                                                    ...
                                                    <h4 className="text-xl font-black text-[#0B1F3A] uppercase tracking-tighter font-sans">{item.title}</h4>
                    ...
                    <div className="mt-24 p-16 bg-[#0B1F3A] rounded-[4rem] text-center space-y-10 relative overflow-hidden group">
                        ...
                        <h3 className="text-3xl md:text-5xl font-black text-white uppercase tracking-tighter font-sans italic leading-none max-w-xl mx-auto">Ready to <span className="text-[#1FA774]">Infiltrate</span> The Job Market?</h3>
