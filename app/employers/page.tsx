                ...
                <section className="relative min-h-[500px] flex items-center bg-[#0B1F3A] overflow-hidden border-b-8 border-b-[#1FA774]">
                        ...
                        <div className="max-w-4xl mx-auto space-y-10">
                            ...
                            <div className="space-y-6">
                                ...
                                <p className="text-xl md:text-2xl text-slate-300 font-medium font-inter max-w-3xl mx-auto leading-relaxed border-transparent italic">
                            ...
                            <div className="grid grid-cols-1 gap-8">
                                            ...
                                            <div className="flex-1 space-y-8">
                                                <div className="flex flex-col md:flex-row md:items-start justify-between gap-6">
                                                    <div className="space-y-2">
                                                        <h2 className="text-3xl font-black text-[#0B1F3A] font-poppins tracking-tighter uppercase group-hover:text-[#1E5EFF] transition-colors leading-none">
                                                            {candidate.name}
                                                        </h2>
                                ...
                                {filteredCandidates.length === 0 && (
                                    <div className="text-center py-40 bg-white rounded-[4rem] border-8 border-slate-50 shadow-inner">
                                        ...
                                        <p className="text-slate-400 font-bold italic font-inter mt-2">Try broader search terms or check our academy for future graduates.</p>
                                    </div>
                                )}
                            </div>
                        </div>
