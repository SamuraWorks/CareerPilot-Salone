            ...
            <main className="flex-1 py-12 px-4 sm:px-6 lg:px-8">
                <div className="max-w-7xl mx-auto">
                    <div className="text-center mb-12">
                        ...
                        <h1 className="text-5xl font-black mb-4 text-[#0B1F3A] tracking-tight uppercase">Mentorship</h1>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-12 max-w-4xl mx-auto text-left">
                            <div className="bg-white border border-slate-100 shadow-sm rounded-3xl p-8 hover:shadow-md transition-all">
                                <div className="flex items-center justify-center gap-4 mb-3">
                                    ...
                                    <span className="text-4xl font-black text-[#0B1F3A]">{MOCK_MENTORS.length}</span>
                                </div>
                                <p className="text-xs font-black text-slate-400 uppercase tracking-widest text-center">Verified Mentors</p>
                            </div>
                            <div className="bg-white border border-slate-100 shadow-sm rounded-3xl p-8 hover:shadow-md transition-all">
                                <div className="flex items-center justify-center gap-4 mb-3">
                                    ...
                                    <span className="text-4xl font-black text-[#0B1F3A]">24H</span>
                                </div>
                                <p className="text-xs font-black text-slate-400 uppercase tracking-widest text-center">Response Rate</p>
                            </div>
                            <div className="bg-white border border-slate-100 shadow-sm rounded-3xl p-8 hover:shadow-md transition-all">
                                <div className="flex items-center justify-center gap-4 mb-3">
                                ...
                                <p className="text-xs font-black text-slate-400 uppercase tracking-widest text-center">Satisfaction</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                        {filteredMentors.map((mentor) => (
                            ...
                            >
                                <Card className="relative overflow-hidden bg-white border border-slate-100 shadow-sm hover:shadow-xl transition-all rounded-[2.5rem] p-8">
                                    ...
                                    <div className="pt-6 mt-6 border-t border-slate-50 flex items-center justify-between">
                                        <div className="flex items-center gap-2">
                                            ...
                                            <span className="text-[10px] font-black text-slate-400 uppercase tracking-widest">+{mentor.menteesCount} Mentees</span>
                                        </div>
            ...
            <AnimatePresence>
                {selectedMentor && (
                    <Dialog open={isProfileOpen} onOpenChange={setIsProfileOpen}>
                        <DialogContent className="max-w-4xl p-0 overflow-hidden border-none rounded-[2rem] bg-white">
                            <DialogTitle className="sr-only">Mentor Profile: {selectedMentor.name}</DialogTitle>
                            {bookingStep === 1 && (
                                <div className="grid grid-cols-1 md:grid-cols-2">
                                    <div className="p-8 md:p-12 bg-slate-50 border-r border-slate-100 h-full">
                                        <div className="relative mb-6">
                                            <Avatar className="w-24 h-24 border-4 border-white shadow-xl">
                                                <AvatarImage src={selectedMentor.image_url} className="object-cover" />
                                                <AvatarFallback className="text-2xl font-black bg-emerald-100 text-emerald-700">
                                        ...
                                        <div className="space-y-4">
                                            <div>
                                                <h2 className="text-3xl font-black text-[#0B1F3A] tracking-tight">{selectedMentor.name}</h2>
                                                <p className="text-emerald-600 font-bold uppercase tracking-widest text-xs mt-1">{selectedMentor.role}</p>
                                            </div>
                                            <p className="text-slate-500 leading-relaxed font-medium">
                                                {selectedMentor.bio}
                                            </p>
                                            <div className="pt-4 space-y-4">
                                                <div className={`flex items-center gap-3 ${selectedMentor.availability === "Free" ? "text-emerald-600" : "text-blue-600"} font-black text-sm uppercase tracking-widest`}>
                                    ...
                                    <div className="p-8 md:p-12 flex flex-col justify-between">
                                        <div className="space-y-8">
                                            <div>
                                                <h3 className="text-xl font-black text-[#0B1F3A] tracking-tight mb-2">Select Your Focus</h3>
                                                <p className="text-slate-500 font-medium">What would you like to discuss?</p>
                                            </div>
                                            ...
                                            <div className="space-y-3">
                                                {selectedMentor.support_types.map(type => (
                                                    <button
                                                        ...
                                                        className={cn(
                                                            "w-full p-6 rounded-2xl border-2 text-left transition-all group relative overflow-hidden",
                                                            selectedTopic === type
                                        ...
                                        <div className="pt-8">
                                            <Button
                                                ...
                                                className="w-full h-16 rounded-[1.5rem] bg-[#0B1F3A] hover:bg-[#1a2f4a] text-white font-black uppercase tracking-widest shadow-xl active:scale-95 transition-all text-xs"
                                            >
                                                Request Guidance
                                            </Button>
                                        </div>
                            ...
                            {bookingStep === 3 && (
                                <div className="p-16 text-center space-y-8">
                                    <div className="w-24 h-24 bg-emerald-100 rounded-[2.5rem] flex items-center justify-center mx-auto text-emerald-600 shadow-lg border-4 border-white">
                                        <CheckCircle2 className="w-12 h-12" />
                                    </div>
                                    <div className="space-y-3">
                                        <h2 className="text-4xl font-black text-[#0B1F3A] tracking-tight">Request Sent!</h2>
                                        <p className="text-slate-500 text-lg font-medium max-w-sm mx-auto italic">
                                            Your session request for **{selectedTopic}** is now on {selectedMentor.name?.split(' ')[0]}'s radar.
                                        </p>
                                    </div>
                                    <Button
                                        onClick={closeDialog}
                                        className="h-16 px-12 rounded-[1.5rem] bg-emerald-600 hover:bg-emerald-700 text-white font-black uppercase tracking-widest shadow-xl transition-all"
                                    >
                                        Back to Explorer
                                    </Button>
                                </div>
