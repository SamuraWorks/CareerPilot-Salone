          ...
          <div className="grid lg:grid-cols-2 gap-8">
            ...
            <div className="space-y-6">
              ...
              <Card className="p-6 bg-secondary/10 border-secondary/20 shadow-md">
                <Badge className="mb-3 bg-secondary text-secondary-foreground hover:bg-secondary/80">Live Beta</Badge>
                <h3 className="font-semibold text-lg mb-2">Start Chatting Now</h3>
              ...
              <Card className="p-6 border-primary/20 bg-primary/5">
                <h3 className="font-bold mb-4 flex items-center gap-2">
                  <span className="bg-primary text-white text-xs px-2 py-1 rounded">Quick Tips</span>
                  Bot Command Cheat Sheet
                </h3>
                <div className="space-y-3 text-sm">
                  <div className="flex justify-between items-center border-b border-primary/10 pb-2">
                    <code className="bg-white px-2 py-1 rounded border font-bold text-primary">CAREER</code>
                    <span className="text-muted-foreground">Start career assessment</span>
                  </div>
                  <div className="flex justify-between items-center border-b border-primary/10 pb-2">
                    <code className="bg-white px-2 py-1 rounded border font-bold text-primary">SKILLS</code>
                    <span className="text-muted-foreground">Log new skills learnt</span>
                  </div>
                  <div className="flex justify-between items-center border-b border-primary/10 pb-2">
                    <code className="bg-white px-2 py-1 rounded border font-bold text-primary">JOBS</code>
                    <span className="text-muted-foreground">Get matched job alerts</span>
                  </div>
                  <div className="flex justify-between items-center border-b border-primary/10 pb-2">
                    <code className="bg-white px-2 py-1 rounded border font-bold text-primary">SCHOLARSHIPS</code>
                    <span className="text-muted-foreground">Find funding</span>
                  </div>
                  <div className="flex justify-between items-center">
                    <code className="bg-white px-2 py-1 rounded border font-bold text-primary">MENU</code>
                    <span className="text-muted-foreground">Show main menu</span>
                  </div>
                </div>
              </Card>
            </div>
