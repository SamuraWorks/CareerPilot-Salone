$url = "https://generativelanguage.googleapis.com/v1beta/models/gemini-pro:generateContent?key=AIzaSyCrmtcYwBbBw1KAYwQ75X0xWHz6dLPZya0"
$body = @{
    contents = @(
        @{ parts = @( @{ text = "Ping" } ) }
    )
...
Write-Host "Testing Key with gemini-pro..."
try {
